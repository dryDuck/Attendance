                 ...
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   ...
                   <div class="dropdown no-arrow">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       ...
                       <a class="dropdown-item" href="<?= base_url('admin/list') ?>">Department List</a>
                     </div>
                   </div>
                 </div>
                 <!-- Card Body -->
                 <div class="card-body" style="max-height: 370px; overflow: scroll; overflow-x : hidden;">
                   <table class="table">
             ...
             <div class="col p-0">
               <div class="card border-left-dark shadow h-100 py-2">
                 <div class="card-body">
                   <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">4SIMD - Pemograman Web</div>
