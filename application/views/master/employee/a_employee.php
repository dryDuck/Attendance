              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                      <label for="e_birth_date" class="col-form-label col-lg-4">Employee Birth Date</label>
                    ...
                    <div class="form-group row">
                      <label for="e_hire_date" class="col-form-label col-lg-4">Employee Hire Date</label>
                      <div class="col-lg p-0">
