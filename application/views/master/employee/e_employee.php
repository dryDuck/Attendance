                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_gender" class="col-form-label">Employee Gender</label>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_birth_date" class="col-form-label">Employee Birth Date</label>
                          <div class="col-lg p-0">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_hire_date" class="col-form-label">Employee Hire Date</label>
                          <div class="col-lg p-0">
                    ...
                    <button type="submit" class="btn btn-success btn-icon-split btn-lg mt-4 float-right">
                      <span class="icon text-white-50">
